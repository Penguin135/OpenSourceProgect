 	...
 	<div class="col-lg-4">
 		<div class="navbar navbar-dark bg-dark" style="padding-top: 20px;">
 			<form method="post" action="loginAction.jsp">
 				<p><h3 style="text-align: center; color:red; font-weight: bold; font-size: 50px;">   만든이 </h3></p>
 				<br>
 			<p><div id='item' style="text-align: center; color:red; font-weight: bold; font-size: 30px;" >  이창주  </div></p>
 			 			<p><div id='item' style="text-align: center; color:red; font-weight: bold; font-size: 30px;" >  김경준  </div></p>
 			 			<p><div id='item' style="text-align: center; color:red; font-weight: bold; font-size: 30px;" >  손상혁  </div></p>
